...
males <- Household[Household$Sex == "Male",]
females <- Household[Household$Sex == "Female",]
...
#4 c
```{r, error=TRUE}
genderCount <- c(male = m, female = f)
#totalFM <- table(Household$Gender)
barplot(genderCount,
main = "Number of Males and Females", xlab = "Gender", ylab = "Count", col = c("green", "purple"))

legend("topright",legend = names(genderCount), fill = c("green", "purple"))
...
knitr::include_graphics("/cloud/project/worksheet#4.rmd/Worksheet#4b/vari.png")
```
...
knitr::include_graphics("/cloud/project/worksheet#4.rmd/Worksheet#4b/bw.png")
```
